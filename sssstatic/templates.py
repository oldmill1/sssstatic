...
<head>
    ...
    <title>{project_name} - Generated by SSSStatic</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <p>This site was created using <strong>SSSStatic</strong>, a simple static site generator.</p>
        <div class="badge">Generated by SSSStatic 🚀</div>
        <div class="footer">
    ...
    <script>
        console.log('🎉 Hello World from SSSStatic!');
